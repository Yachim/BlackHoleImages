...
Black holes are one of the most intriguing objects in modern physics. They were one of the earliest predictions of Einstein's general relativity and starting from the 1960s they were deduced to possibly exist in the Universe through observations in various electromagnetic bands [@EMBHRev]. Since most observations were and still are unable to resolve the spatial scales of the so-called event horizon of the black hole, one needs to understand the radiation that emerges from the interactions of the black hole with its surroundings, in particular its overall emergent spectrum. This was provided by the seminal $\alpha$ accretion disk model of Shakura & Sunyaev [-@Shakura] and Novikov & Thorne [-@NovikovThorne]. It was thanks to these seminal results that the community of astronomers and astrophysicists identified the first candidates for black holes in the Universe.

Currently, the evidence for dark compact objects consistent with black holes is overwhelming. Throughout the 1990s, two teams of astronomers followed stars orbiting very close to our Galactic center and deduced on the presence of a dark compact object with the mass of^[$M_{\odot} \approx 2 \times 10^{30}$ kg is the solar mass.] $4\cdot 10^6 M_\odot$ [@Genzel;@Ghez]; the leaders of the teams later shared the 2020 Nobel prize in physics [@NobelGenzelGhez]. In 2015, the LIGO collaboration detected the first merger of black holes by gravitational waves [@GWBH] and more than 180 events were detected to date [@GWOSC]. In 2017, the Event Horizon Telescope collaboration reconstructed a radio-band image of the accretion flow in the immediate vicinity of the massive black hole in the center of the M87 galaxy by the methods of very long baseline interferometry [@EHTM87]. They followed up this result in 2020 by presenting a similar image of the accretion flow from the center of our very own Galaxy the Milky Way [@EHTSgrA].
